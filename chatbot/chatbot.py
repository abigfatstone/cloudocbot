...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        datasetArgs.add_argument('--vocabularySize', type=int, default=400, help='Limit the number of words in the vocabulary (0 for unlimited)')
        ...
        trainingArgs.add_argument('--numEpochs', type=int, default=2, help='maximum number of epochs to run')
    ...
    def mainTestInteractive(self, sess):
        ...
        print('Welcome to the interactive mode, here you can ask to Deep Q&A the sentence you want. Don\'t have high '
              'expectation. Type \'exit\' to quit the program. Have fun.')
